...
namespace DiscordChatPlugin.Plugins
{
    public partial class DiscordChat
    {
        ...
        public string ProcessPlaceholders(string key, PlaceholderData data)
        {
            ...
            return data != null ? _placeholders.ProcessPlaceholders(message, data) : message;
        }
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                [LangKeys.Discord.Player.Connected] = $":white_check_mark: ({{timestamp.now.shorttime}}) **{{{PlaceholderKeys.PlayerName}}}** has joined.",
